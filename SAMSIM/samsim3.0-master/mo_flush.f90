...
CONTAINS
  ...
  SUBROUTINE flush3 (freeboard,psi_l,thick,thick_0,S_abs,H_abs,m,T,dt,Nlayer,N_active,&
       ...
       & psi_g,rho_l,snow_flush_flag,fl_brine_bgc)
    ...
    REAL(wp),                     INTENT(in)    :: dt,T_bottom,S_bu_bottom,freeboard,thick_0,rho_l
  ...
  !!
  SUBROUTINE flush4 (psi_l,thick,T,S_abs,H_abs,m,Nlayer,N_active,melt_thick,debug_flag)
