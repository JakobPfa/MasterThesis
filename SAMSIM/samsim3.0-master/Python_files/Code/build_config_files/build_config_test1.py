...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 20 12:44:04 2022
...
config['time_total'] = config['time_out'] * 24 * 3 # total length of simulation [s]
...
# Set variable inputs
T_top = Tstep(-10, -8, config['time_total'], config['timestep_data'])
